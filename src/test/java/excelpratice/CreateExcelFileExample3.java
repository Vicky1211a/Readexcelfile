...
String filename = "E:\\Created Excel\\studentlist.xls\\";  
...
//creating the 3nd row
HSSFRow row2 = sheet.createRow((short)3);
//inserting data in the third row
row2.createCell(0).setCellValue("2");
row2.createCell(1).setCellValue("vicky");
row2.createCell(2).setCellValue("44444444");
row2.createCell(3).setCellValue("vickyk@gmail.com");
row2.createCell(4).setCellValue("300000.00");
